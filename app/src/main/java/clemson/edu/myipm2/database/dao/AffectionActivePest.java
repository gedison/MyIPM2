...
public class AffectionActivePest extends TableEntry{
    ...
    AffectionActivePest(String activeId, String name, String codeName, String color, String efficacy, String fieldUse, String consumer, String worker, String ecological){
        this.name = name;
    ...
    AffectionActivePest(String[] result){
        name = result[0];
        codeName = result[1];
        color = result[2];
        efficacy = result[3];
